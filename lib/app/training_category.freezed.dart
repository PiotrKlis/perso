...
mixin _$TrainingCategory {
  ...
  Text get name => throw _privateConstructorUsedError;
...
abstract class $TrainingCategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({Widget icon, Text name});
}
...
class _$_TrainingCategory implements _TrainingCategory {
  const _$_TrainingCategory({required this.icon, required this.name});
  ...
  @override
  String toString() {
    return 'TrainingCategory(icon: $icon, name: $name)';
  }
...
abstract class _TrainingCategory implements TrainingCategory {
  const factory _TrainingCategory(
      ...
      required final Text name}) = _$_TrainingCategory;
