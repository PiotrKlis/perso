      ...
      builder: (context, state) {
        return state.whenOrNull(
            ...
            PersoButton(
              title: 'Save',
              onTap: (context) {
                if (exerciseInheritedWidget.optionsFormKey.currentState!
                        .validate() &&
                    exerciseInheritedWidget.breakFormKey.currentState!
                        .validate()) {
                  final exerciseOptionsData = exerciseInheritedWidget
                      ...
                      .exerciseOptionsData;
                  final optionsData =
                      switch (exerciseOptionsData.exerciseType) {
                  ...
                  context.read<ExerciseDetailsBloc>().add(
                        ExerciseDetailsEvent.saveExercise(
                          ...
                          exerciseInTrainingEntity: exerciseInheritedWidget
