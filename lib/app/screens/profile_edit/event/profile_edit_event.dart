...
class ProfileEditEvent with _$ProfileEditEvent {
  const factory ProfileEditEvent.uploadTrainerData(EditableTrainerData trainerData) = UploadTrainerData;
  const factory ProfileEditEvent.uploadClientData(EditableClientData clientData) = UploadClientData;
}
