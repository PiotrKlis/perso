...
class TrainerSearchCarouselState with _$TrainerSearchCarouselState {
  ...
  const factory TrainerSearchCarouselState.content({required List<TrainersSearchCarouselCardData> cardsData}) = Content;
  const factory TrainerSearchCarouselState.error({required String error}) = Error;
}
