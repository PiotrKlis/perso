...
class TrainingCategoryListState with _$TrainingCategoryListState {
  ...
  const factory TrainingCategoryListState.content({required List<TrainingCategory> categories}) = _Content;
  const factory TrainingCategoryListState.error({required String error}) = _Error;
}
