...
mixin _$TrainersListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<TrainerCard> trainers) content,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<TrainerCard> trainers)? content,
...
abstract class _$$ContentCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<TrainerCard> trainers});
}
...
class _$Content implements Content {
  const _$Content({required final List<TrainerCard> trainers})
      : _trainers = trainers;

  final List<TrainerCard> _trainers;
  @override
  List<TrainerCard> get trainers {
...
abstract class Content implements TrainersListState {
  const factory Content({required final List<TrainerCard> trainers}) =
      _$Content;
