...
part of 'editable_trainer_data.dart';
...
/// @nodoc
abstract class $EditableTrainerDataCopyWith<$Res> {
  factory $EditableTrainerDataCopyWith(
          EditableTrainerData value, $Res Function(EditableTrainerData) then) =
      _$EditableTrainerDataCopyWithImpl<$Res, EditableTrainerData>;
  @useResult
  $Res call(
      {String imagePath,
...
/// @nodoc
class _$EditableTrainerDataCopyWithImpl<$Res, $Val extends EditableTrainerData>
    implements $EditableTrainerDataCopyWith<$Res> {
  _$EditableTrainerDataCopyWithImpl(this._value, this._then);
...
abstract class _EditableTrainerData implements EditableTrainerData {
  const factory _EditableTrainerData(
